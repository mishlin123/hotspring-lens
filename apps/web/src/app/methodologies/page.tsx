...
const sampleDistribution = [
  ...
  { volume: '~10 g', container: 'Sediment container', purpose: 'Sediment sample where possible, for future research' },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              ...
              reducing double-handling of field notes and transcription errors. Metadata
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-slate-100">
                {processingTable.map((row, i) => (
                  <tr key={i} className="bg-white hover:bg-slate-50 transition-colors">
                    <td className="px-3 py-2.5 text-slate-600 whitespace-nowrap">{row.bottle}</td>
                    <td className="px-3 py-2.5 text-slate-600">{row.processing}</td>
                    ...
                    <td className="px-3 py-2.5 text-slate-600">{row.method}</td>
                    <td className="px-3 py-2.5 text-slate-500">{row.location}</td>
                  </tr>
                ))}
              </tbody>
            </table>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-600">
                    ...
                    <div className="col-span-full mt-2 pt-2 border-t border-slate-100">
                      ...
                      <p className="text-xs text-slate-600">
                        Initial denaturation 94 °C / 3 min, then 30 cycles: 94 °C / 45 s · 50 °C / 1 min · 72 °C / 1.5 min, followed by final extension 72 °C / 10 min
                      </p>
                    </div>
                  </div>
                ),
              ...
              <div className="space-y-3 text-sm text-amber-800">
                <div className="bg-white border border-amber-200 rounded-xl p-5">
                  ...
                  <p>
                    ...
                    preferred over gumboots because they provide better ankle support and protection in
                    unstable terrain.
                  </p>
                </div>
                <div className="bg-white border border-amber-200 rounded-xl p-5">
