    ...
    <div className="pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-l-4 border-red-600 pl-5 mb-8">
          ...
          <p className="text-2xl font-bold text-slate-900 mb-3 leading-tight">
          ...
          <div className="divide-y divide-slate-100">
            {[
              ...
              <div key={rule.title} className="grid grid-cols-[2.5rem_1fr] gap-4 py-5">
                ...
                <div>
                  <p className="font-semibold text-slate-800 mb-1">{rule.title}</p>
        ...
        <section className="mb-14 border-t-2 border-red-600 pt-6">
          ...
          <div className="flex items-baseline gap-5 mb-7">
            ...
            <p className="text-base text-slate-600">New Zealand emergency services</p>
          </div>
          <div className="divide-y divide-slate-100 text-base text-slate-800">
        ...
        <section className="mb-12 border-t border-slate-200 pt-8">
          ...
          <div className="text-base text-slate-800 space-y-2.5 leading-relaxed">
